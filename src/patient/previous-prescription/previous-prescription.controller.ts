...
@Controller('MedicalHistory/PreviousPrescription')
export class PreviousPrescriptionController {
  constructor(private readonly service: PreviousPrescriptionService) {}
